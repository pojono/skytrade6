...
for sym in ALL_SYMBOLS:
    ...
    for idx in events.index:
        ...
        # User has 0.2% (20 bps) round-trip fees.
        # Plus 13 bps historical slippage.
        # Total drag = 33 bps (0.0033)
        net_ret = (exit_price / entry_price) - 1 - 0.0033
...
if len(df_accepted) > 0:
    print("--- User's Actual Fee Tier Performance ---")
    print(f"Total Drag Assumed: 33 bps (20 bps round-trip taker + 13 bps average slippage)")
