#!/usr/bin/env python3
"""
Exit ML v2 — Predict the BOTTOM, not the next 1s
==================================================
Key insight: We have ONE exit. The question is NOT "will it drop in the next 1s?"
but "Is THIS the deepest point in the remaining window?"

Targets:
  - future_drop_remaining_bps: how many more bps of drop remain (regression)
  - near_bottom: 1 if within 10 bps of eventual minimum (classification)
  - at_bottom: 1 if within 5 bps of eventual minimum (stricter)

Exit logic: when model predicts "near_bottom" with high confidence → EXIT (once!)

Usage:
    python3 research_exit_ml_v2.py
"""
