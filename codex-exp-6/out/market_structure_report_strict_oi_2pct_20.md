...
- breadth_trend 5m: gross `1.94` bps, maker net `-6.06` bps, samples `24180`
- breadth_trend 1m: gross `1.89` bps, maker net `-6.11` bps, samples `21222`
...
- breadth_trend 1m: splits `3`, avg maker `-6.12` bps, worst maker `-6.52` bps, avg taker `-18.12` bps
- breadth_trend 5m: splits `3`, avg maker `-6.16` bps, worst maker `-6.60` bps, avg taker `-18.16` bps
