...
def backtest_strategy(df, symbol):
    ...
    df['bounce_conf'] = df['ret_15m'] > 0.02
...
def main():
    ...
    print(f"Testing Confirmed Bounce Strategy (Flush + 2% 15m Bounce)...")
    ...
    print("\n=== CONFIRMED BOUNCE STRATEGY RESULTS ===")
    ...
    trades_df.to_csv("/home/ubuntu/Projects/skytrade6/gemini-1/v5_adaptive_trades.csv", index=False)
    print("Saved trades to gemini-1/v5_adaptive_trades.csv")
