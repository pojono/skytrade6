...
def run_strat_3_dynamic_opt(symbol):
    ...
    # Let's try to optimize for catching the extreme wick (15% TP) with a wider stop to avoid getting shaken out before the cascade (8% SL)
    results = run_backtest_tp_sl(df, tp_pct=0.15, sl_pct=0.08, fee_bps=5.0)
...
if __name__ == "__main__":
    ...
    print("--- Backtesting Strategy 3: Powder Keg with Wider TP/SL (15% TP / 8% SL) ---")
