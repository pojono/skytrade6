...
def run_backtest_with_trailing_stop(df, max_hold_periods=48, trailing_stop_bps=500.0, take_profit_bps=1000.0, fee_bps=5.0):
...
def run_strat_3(symbol):
    ...
    # Hold up to 48 hours (48 periods). 
    # Take Profit: +10% (1000 bps)
    # Trailing Stop: -5% (500 bps)
    results = run_backtest_with_trailing_stop(df, max_hold_periods=48, trailing_stop_bps=500.0, take_profit_bps=1000.0, fee_bps=5.0)
...
if __name__ == "__main__":
    ...
    print("--- Backtesting Strategy 3: Powder Keg V2 (Trailing Stop + Take Profit) ---")
